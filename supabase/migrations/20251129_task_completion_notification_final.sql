-- Migration: Final Fix for Task Completion Notification Trigger
-- Description: Explicitly drops and recreates the trigger and function to ensure 'event_id' is used.
...
DROP FUNCTION IF EXISTS public.handle_task_completion_notification();

-- 2. Recreate the function with the CORRECT column name (event_id)
